...
if(DEFINED OHOS_NDK AND NOT OHOS_NDK STREQUAL "")
    message(STATUS " OHOS_NDK_HOME is ${OHOS_NDK}.")
else()
    message(FATAL_ERROR "environment parameter OHOS_NDK_HOME is not set.")
endif()
 
#TODO:use different native directory according host os and version
string(CONCAT OHOS_SDK_NATIVE "${OHOS_NDK}" "/")
...
# set the sdk native platform //TODO:需要修改
